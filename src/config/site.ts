...
export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: "Hmar Locale Project",
      shortDescription:
        "Standardizing Hmar UI and UX keys, mobile app strings, and operating system translation keys.",
      fullDescription:
        "A formal software localization project providing open-source maintainers and developers with standardized Hmar translation keys (i18n JSON, PO, XLIFF files) for mobile apps, operating systems, and web software.",
      status: "In Planning",
      iconName: "Globe",
      category: "Software Locale",
      targetUrl: "#",
      githubUrl: "https://github.com/hmar-heritage",
      notes: "Focuses on technical UI and UX translation keys to avoid smartphone culture shock.",
      grantScope: "Open Source Software & Technical i18n Grants (Mozilla, Linux Foundation, Google CLDR)",
      deliverables: [
        "Standardized Hmar UI and UX translation keys for mobile and web software",
        "Raw software locale dataset mirror on Hugging Face: ui-ux-locales",
        "i18n JSON, PO, and XLIFF export formats for app developers",
