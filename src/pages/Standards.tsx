        ...
        <div className="max-w-3xl mx-auto space-y-16">
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              This specification serves as a formal operational justification and open request to academic researchers, comparative linguists, native scholars, and community advocates. Rather than expecting institutional maintainers at <strong>Glottolog</strong> (Max Planck Institute for Evolutionary Anthropology), <strong>SIL International / Ethnologue</strong>, or <strong>ISO 639 Registration Authorities</strong> to discover this document on their own, we present this rationale to persuade scholars to adopt these standards in their field work, and possibly petition upstream governing bodies for accurate classification and metadata updates.
            </p>
            <p className="text-stone-700 leading-relaxed text-base">
              However, we must clarify the distinction: this document is an operational policy statement of the Hmar Heritage Foundation, not a peer-reviewed academic research paper or a scientific declaration. The citations included throughout are provided to show that our metadata standards align with existing comparative linguistics research rather than unsupported assertions.
            </p>
            <p className="text-stone-700 leading-relaxed text-base">
              The Foundation does not intend to impose these standards or establish authority over global language registries or neighboring speech communities. Our purpose is to establish clear, transparent standards for our own open datasets, software metadata, and community digital archives, while providing a clean open-access benchmark for developers and researchers. We explicitly recognize that Glottolog did not invent these historical colonial exonyms, but simply recorded what existing published literature contained. However, as Glottolog has become the primary programmatic taxonomy root powering modern language technology and AI pipelines worldwide, it has become responsible for how these legacy labels are perpetuated into the digital future.
            </p>
            ...
            <div className="my-6 overflow-x-auto rounded-xl border border-stone-200 shadow-xs bg-white text-xs sm:text-sm font-sans">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-stone-200 text-stone-700">
                  <tr><td className="px-4 py-2.5 font-bold text-stone-900 border-r border-stone-200">Ṭhiek (Khawsak &amp; Ṭhiek)</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800">hmr / hmar1241 (khaw1234 &amp; thie1234 · Literary Standard)</td></tr>
                  ...
                  <tr className="bg-stone-50/50"><td className="px-4 py-2.5 font-bold text-stone-900 border-r border-stone-200">Changsan (Changsen)</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800">chan1312 <span className="text-stone-600 font-sans">(Subsumed under hmr · Potentially Extinct)</span></td></tr>
                  ...
                  <tr className="bg-stone-50/50"><td className="px-4 py-2.5 font-bold text-amber-900 border-r border-stone-200">Faihriem (Saihriem / Syriem)</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200 text-stone-400">-</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800 font-semibold">syri1242 (Distinct Variety · Unlisted ISO)</td></tr>
                  <tr><td className="px-4 py-2.5 font-bold text-stone-900 border-r border-stone-200">Biate (Biete / Baite)</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200 text-stone-400">-</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800">biu / biet1238 &amp; bait1247 (Distinct Variety)</td></tr>
                  <tr className="bg-stone-50/50"><td className="px-4 py-2.5 font-bold text-stone-900 border-r border-stone-200">Hrangkhawl (Hrangkol / Halam)</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800">hra / hran1239 &amp; hran1240 (Distinct Variety)</td></tr>
                  ...
                  <tr className="bg-stone-50/50"><td className="px-4 py-2.5 font-bold text-stone-900 border-r border-stone-200">Sakachep</td><td className="px-4 py-2.5 text-center border-r border-stone-200 text-stone-400">-</td><td className="px-4 py-2.5 text-center border-r border-stone-200 text-stone-400">-</td><td className="px-4 py-2.5 text-center border-r border-stone-200">Yes</td><td className="px-4 py-2.5 font-mono text-emerald-800">sch / saka1283 (Distinct Variety)</td></tr>
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              The Hmar Heritage Foundation encourages moving beyond legacy colonial umbrella terms, specifically macro-labels like "Kuki-Chin-Naga" and "Kuki-Chin", which were originally introduced for administrative convenience rather than genetic relationships. Even Sir George Abraham Grierson, who compiled the <em>Linguistic Survey of India</em> (LSI Vol. III, Part III, 1904), explicitly admitted that these labels were external exonyms:
            </p>
            <blockquote className="my-4 border-l-4 border-emerald-800 pl-4 py-3 italic text-stone-800 bg-emerald-50/50 rounded-r-md font-serif text-sm">
              "The denomination Kuki-Chin is a purely conventional one, there being no proper name comprising all these tribes... Kuki is an Assamese or Bengali term, applied to various hill tribes... Chin is a Burmese word used to denote the various hill tribes living in the country between Burma and the Provinces of Assam and Bengal. It is written and dialectically pronounced Khyang. The name is not used by the tribes themselves, who use titles such as Zo or Yo and Sho."
              <span className="block not-italic text-xs font-mono text-stone-500 mt-2 font-bold">G.A. Grierson, Linguistic Survey of India, Vol. III, Part III (1904, pp. 1–2)</span>
            </blockquote>
            <p className="text-stone-700 leading-relaxed text-base">
              In place of these colonial labels, the Foundation advocates for adopting the authentic autonym <strong>Zo</strong> (historically <em>Zo hnahthlak</em>; Chakraborty 2013), academically described as <em>South-Central Tibeto-Burman</em>, as the family name for the 55 closely related speech varieties across Northeast India, Western Myanmar, and the Chittagong Hill Tracts. Modern comparative studies (Lotven, Van Bik et al., 2020) explicitly acknowledge that legacy exonyms like "Kuki" and "Chin" are loaded colonial terms, whereas the underlying speech communities form a distinct, genealogically coherent family (VanBik 2009; Thurgood 2017).
            </p>
            <p className="text-stone-700 leading-relaxed text-base">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              Respecting native cultural sentiments by adopting authentic autonyms like <strong>Zo</strong> provides a clear, respectful path forward. The Foundation operationalizes the <strong>Zo</strong> classification across all its public datasets, open software metadata, and digital archives as a practical benchmark.
            </p>
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold text-stone-900">
                Historical Critique & Modern Taxonomic Consensus
              </h3>
            </div>
            <p className="text-stone-700 leading-relaxed text-base">
              The historical error began in colonial-era surveys (Grierson 1904; Konow 1909), which relied on superficial word-order criteria and geographical administrative convenience rather than comparative sound laws (Shafer 1955). Grierson placed Meitei, a historically valley-dwelling population of the Imphal Valley, under the same Kuki-Chin umbrella, despite explicitly acknowledging that Meitei possesses structural, morphological, and lexical ties that align it more closely with Written Burmese and Classical Tibetan than with the surrounding hill languages:
            </p>
            <blockquote className="my-4 border-l-4 border-emerald-800 pl-4 py-3 italic text-stone-800 bg-emerald-50/50 rounded-r-md font-serif text-sm">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              Modern comparative scholarship explicitly rejects these colonial catchall labels. In <em>The Sino-Tibetan Languages</em> (2nd Edition, 2017), leading linguists Mark W. Post, Robbins Burling, Graham Thurgood, and Shobhana L. Chelliah formally dismantle composite nodes like "Kuki-Chin-Naga":
            </p>
            <blockquote className="my-4 border-l-4 border-emerald-800 pl-4 py-3 italic text-stone-800 bg-emerald-50/50 rounded-r-md font-serif text-sm">
              "Despite the existence of 'catchall' labels such as 'Baric', 'North Assam', 'Kamarupan' and now 'Northeast Indian', the languages of Northeast India have never been demonstrated to form a genealogical unit within Tibeto-Burman: nor, we believe, can they ever be... We therefore maintain Burling's (2003) practice of treating Tangkhulic, Karbi, Meitei and Kuki-Chin as independent branches."
              <span className="block not-italic text-xs font-mono text-stone-500 mt-2 font-bold">Mark W. Post & Robbins Burling, The Sino-Tibetan Languages (2nd ed., Routledge 2017, pp. 217, 231)</span>
            </blockquote>
            <p className="text-stone-700 leading-relaxed text-base">
              Similarly, Chelliah (2017, p. 295) re-classifies Meitei as an independent coordinate branch (DeLancey 1987; Chelliah 1997; Burling 2017), noting that early assignments to Kuki-Chin-Naga were based on geographic convenience rather than shared genetic innovations.
            </p>
          </article>
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              To replace colonial administrative shortcuts with scientific accuracy, the Foundation advocates for separating non-Zo language branches from the top-level macro-node (Glottocode: <code className="font-mono">kuki1245</code>, 94 speech varieties) into independent coordinate nodes, while renaming the remaining parent node to the authentic autonym <strong>Zo</strong> (55 speech varieties).
            </p>
            <p className="text-stone-700 leading-relaxed text-base">
              As demonstrated by Thurgood (2017, p. 23) and VanBik (2009), the 55 Zo speech varieties form a distinct, genealogically coherent family supported by reconstructed Proto-Zo phonology, shared stem alternations, and subject agreement proclitics. For database maintainers, re-assigning non-Zo branches into their own independent Sino-Tibetan nodes aligns global digital registries with modern peer-reviewed cladistics.
            </p>
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-stone-700 text-base leading-relaxed">
              <li>
                <strong>Misplaced Ancestral Hmar Clans:</strong> Ancestral core clans of the Hmar people (<em>Hnam 14</em>) are arbitrarily split across distant tree branches in Glottolog. For example, <em>Changsan (Changsen)</em> (Glottocode: <code className="font-mono text-emerald-800">chan1312</code>) is indexed under <code className="font-mono text-xs">Peripheral Kuki-Chin -&gt; Northeastern -&gt; Thadoic -&gt; Thado Chin</code>, while standard <em>Hmar</em> is placed under <code className="font-mono text-xs">Central Kuki-Chin -&gt; Mizoic -&gt; Hmaric</code>. Similarly, <em>Syriem (Saihriem)</em> (Glottocode: <code className="font-mono text-emerald-800">syri1242</code>) is placed under <code className="font-mono text-xs">Western Northwestern Kuki-Chin -&gt; Sakachep-Chorei</code>. This demonstrates that colonial officers recorded clan names in isolation during regional administrative surveys, and registry frameworks converted those historical shortcuts into split tree branches.
              </li>
              <li>
                <strong>Duplicated Nodes across Sub-branches:</strong> Single clan speech entities are frequently fragmented into duplicate registry nodes. For example, <em>Hrangkhawl (Hrangkol)</em> is indexed twice under separate parent branches in Glottolog (placed under <code className="font-mono text-xs">Mizoic -&gt; Hmaric</code> as <code className="font-mono text-emerald-800">hran1239</code> with ISO <code className="font-mono">hra</code>, as well as under <code className="font-mono text-xs">Western Northwestern Kuki-Chin -&gt; Halam</code> as <code className="font-mono text-emerald-800">hran1240</code>). Similarly, <em>Ralte</em> is duplicated under both <code className="font-mono text-xs">Mizoic -&gt; Mizo</code> and <code className="font-mono text-xs">Thadoic -&gt; Paiteic</code>.
              </li>
              <li>
          ...
          <article className="space-y-4 border-b border-stone-200 pb-12">
            ...
            <p className="text-stone-700 leading-relaxed text-base">
              For now, the Foundation prioritizes implementing these metadata standards internally across our own open datasets, software metadata, and digital documentation, providing a clean open-access benchmark for developers and researchers, while leaving formal upstream registry petitions for future academic and community initiatives.
            </p>
          </article>
