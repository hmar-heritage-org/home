      ...
      <div className="space-y-12 text-slate-800 leading-relaxed text-base font-sans pt-2">
        ...
        <section className="space-y-4 border-b border-slate-200 pb-10">
          ...
          <div className="prose prose-slate max-w-none text-slate-700 space-y-4 text-base">
            ...
            <p>
              Native speech communities must have a direct voice in how their speech varieties are represented in global registries. Currently, international standards bodies like SIL Ethnologue and ISO 639-3 display arbitrary inconsistencies when cataloging Hmar speech varieties. For instance, speech varieties such as <strong>Leiri</strong> and <strong>Zote</strong> possess distinct linguistic identities spoken by native communities, yet they do not have dedicated ISO 639-3 language codes in global registries. They are either administratively subsumed under broader codes or omitted from international listings entirely.
            </p>
            <p>
              We emphasize that these registry discrepancies stem from historical institutional neglect and minimal community participation in international standards bodies rather than malice. Expanding direct community representation ensures that ISO 639-3 and Ethnologue metadata accurately reflect living language relationships as understood by native speakers.
            </p>
